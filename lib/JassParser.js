...
class JassParser extends ExpressionParser {
  constructor (...args) {
    ...
    $.RULE('vardeclaration', () => {
      ...
      $.CONSUME4(tokenVocabulary.identifier)
    })
